...
<div class="row seccion">
    ...
    <div id="" style="width: 100%">
        <img style="width: 100%" src="/sitio_web/application/assets/img/contenido/equipoSocial/territoriosSATC/QuebradaElSalado.png" alt="Quebrada El Salado - Jamindí">
    </div>
    <br><br>
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 col-md-5 col-sm-5 col-xs-5" >
                <br>
                <p><b>MUNICIPIO:</b> Girardota</p>
                <p><b>BARRIO O CORREGIMIENTO:</b> Vereda Jamundí</p>
                <p><b>SECTOR:</b> Guaduales</p>
                <p><b>CUENCA:</b> Q. El Salado</p>
