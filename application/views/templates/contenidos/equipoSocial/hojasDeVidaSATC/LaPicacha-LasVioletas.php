...
<div class="row seccion">
    ...
    <div id="" style="width: 100%">
        <img style="width: 100%" src="/sitio_web/application/assets/img/contenido/equipoSocial/territoriosSATC/QuebradaLaPicachaLasVioletas.png" alt="Quebrada La Picacha - Las Violetas">
    </div>
    <br><br>
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 col-md-5 col-sm-5 col-xs-5" >
                ...
                <p><b>BARRIO O CORREGIMIENTO:</b> Belén</p>
                <p><b>SECTOR:</b> Las Violetas</p>
                <p><b>CUENCA:</b> Q. La Picacha</p>
                <p><b>ÁREA:</b>  6,74 Km<sup>2</sup></p>
            </div>
        </div>
    </div>
    <br><br>
    ...
    <br><br>
        <div style="text-align: center;">
            <iframe style="width: 80%; height:70%;" src="https://www.youtube.com/embed/iioyZFZIaBU"
    ...
    <?php $this->view('templates/header/importScripts')?>
     ...
     <script>
        cargar_mapa('https://siata.gov.co/sitio_web/application/assets/kml/equipoSocial/hojaDeVidaSATC/Medellin_LasVioletas_LaPicacha.kml');
     </script>
</html>
