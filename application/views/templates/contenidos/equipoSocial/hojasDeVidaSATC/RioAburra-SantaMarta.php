...
<div class="row seccion">
    ...
    <div id="" style="width: 100%">
        <img style="width: 100%" src="/sitio_web/application/assets/img/contenido/equipoSocial/territoriosSATC/RioAburraMedellinSantaMarta.png" alt="Rio Medellín - Santa Marta">
    </div>
    <br><br>
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 col-md-5 col-sm-5 col-xs-5" >
                ...
                <p><b>BARRIO O CORREGIMIENTO:</b> El Hatillo</p>
                <p><b>SECTOR:</b> Santa Marta</p>
                <p><b>CUENCA:</b> Río Aburrá - Medellín</p>
                <p><b>ÁREA:</b> 846,39 Km<sup>2</sup></p>
            </div>
        </div>
    </div>
    <br><br>
    ...
    <br><br>
        <div style="text-align: center;">
            <iframe style="width: 80%; height:70%;" src="https://www.youtube.com/embed/_URYGVNXwOY"
    ...
    <?php $this->view('templates/header/importScripts')?>
     ...
     <script>
        cargar_mapa('https://siata.gov.co/sitio_web/application/assets/kml/equipoSocial/hojaDeVidaSATC/Barbosa_SantaMarta_RioAburra.kml');
    </script>
