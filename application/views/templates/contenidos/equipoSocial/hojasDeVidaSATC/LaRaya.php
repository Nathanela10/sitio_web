...
<div class="row seccion">
    ...
    <div id="" style="width: 100%">
        <img style="width: 100%" src="/sitio_web/application/assets/img/contenido/equipoSocial/territoriosSATC/QuebradaLaRaya.png" alt="Quebrada La Raya">
    </div>
    <br><br>
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 col-md-5 col-sm-5 col-xs-5" >
                <br>
                <p><b>MUNICIPIO:</b> La Estrella</p>
                <p><b>BARRIO O CORREGIMIENTO:</b> La Raya</p>
                <p><b>SECTOR:</b> La Raya</p>
                <p><b>CUENCA:</b> Q. La Raya</p>
                <p><b>ÁREA:</b> 0,29 Km<sup>2</sup></p>
            </div>
        </div>
    </div>
    <br><br>
    ...
    <div style="text-align: center;">
        <iframe style="width: 80%; height:70%;" src="https://www.youtube.com/embed/kvScj1B8raI"
    ...
    <br><br>
    <div style="text-align: center;">
        <iframe style="width: 80%; height:70%;" src="https://www.youtube.com/embed/jQTR8HXgPL0"
                frameborder="0" allowfullscreen></iframe>
    </div>
    ...
    <?php $this->view('templates/header/importScripts')?>
     ...
     <script>
        cargar_mapa('https://siata.gov.co/sitio_web/application/assets/kml/equipoSocial/hojaDeVidaSATC/LaEstrella_LaRaya.kml');
     </script>
