...
<div class="row seccion">
    ...
    <div id="" style="width: 100%">
        <img style="width: 100%" src="/sitio_web/application/assets/img/contenido/equipoSocial/territoriosSATC/QuebradaLaCorrala.png" alt="Quebrada La Corrala">
    </div>
    <br><br>
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 col-md-5 col-sm-5 col-xs-5" >
                <br>
                <p><b>MUNICIPIO:</b> Caldas</p>
                <p><b>BARRIO O CORREGIMIENTO:</b> Andalucía</p>
                <p><b>SECTOR:</b> Andalucía</p>
                <p><b>CUENCA:</b> Q. La Corrala</p>
                <p><b>ÁREA:</b> 1,72 Km<sup>2</sup></p>
            </div>
        </div>
    </div>
    <br><br>
