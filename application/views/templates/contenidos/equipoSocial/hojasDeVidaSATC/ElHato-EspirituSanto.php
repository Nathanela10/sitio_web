...
<div class="row seccion">
    ...
    <div id="" style="width: 100%">
        <img style="width: 100%" src="/sitio_web/application/assets/img/contenido/equipoSocial/territoriosSATC/QuebradaElHato.png" alt="Quebrada El Hato">
    </div>
    <br><br>
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 col-md-5 col-sm-5 col-xs-5" >
                ...
                <p><b>BARRIO O CORREGIMIENTO:</b> Espíritu Santo</p>
                <p><b>SECTOR:</b> Espíritu Santo</p>
                <p><b>CUENCA:</b> Q. El Hato</p>
                <p><b>ÁREA:</b> 18,42 Km<sup>2</sup></p>
            </div>
        </div>
    </div>
    <br><br>
    ...
    <br><br>
        <div style="text-align: center;">
            <iframe style="width: 80%; height:70%;" src="https://www.youtube.com/embed/wsPzYN9inyA"
    ...
    <?php $this->view('templates/header/importScripts')?>
     ...
     <script>
        cargar_mapa('https://siata.gov.co/sitio_web/application/assets/kml/equipoSocial/hojaDeVidaSATC/Bello_EspirituSanto_ElHato.kml');
     </script>
</html>
