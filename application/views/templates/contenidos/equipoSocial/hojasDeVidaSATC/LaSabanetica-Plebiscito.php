...
<div class="row seccion">
    ...
    <div id="" style="width: 100%">
        <img style="width: 100%" src="/sitio_web/application/assets/img/contenido/equipoSocial/territoriosSATC/QuebradaLaDoctoraPlesbicito.png" alt="Quebrada La Doctora - Plesbicito">
    </div>
    <br><br>
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 col-md-5 col-sm-5 col-xs-5" >
                ...
                <p><b>BARRIO O CORREGIMIENTO:</b> Calle Larga</p>
                <p><b>SECTOR:</b> El Plebiscito</p>
                <p><b>CUENCA:</b> Q. La Sabanetica - Q. San Alejo</p>
