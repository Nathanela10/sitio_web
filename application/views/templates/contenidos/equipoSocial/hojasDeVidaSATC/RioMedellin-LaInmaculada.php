...
<div class="row seccion">
    ...
    <div id="" style="width: 100%">
        <img style="width: 100%" src="/sitio_web/application/assets/img/contenido/equipoSocial/territoriosSATC/RioAburraMedellinLaInmaculada.png" alt="Rio Aburra La Inmaculada">
    </div>
    <br><br>
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 col-md-5 col-sm-5 col-xs-5" >
                ...
                <p><b>BARRIO:</b> La Inmaculada</p>
                <p><b>SECTOR:</b> La Inmaculada</p>
                <p><b>CUENCA:</b> Río Aburrá - Medellín</p>
                <p><b>ÁREA:</b> 118,01 Km<sup>2</sup></p>
            </div>
        </div>
    </div>
    <br><br>
    ...
    <br><br>
        <div style="text-align: center;">
            <iframe style="width: 80%; height:70%;" src="https://www.youtube.com/embed/GInitxUA_oU"
    ...
    <?php $this->view('templates/header/importScripts')?>
     ...
     <script>
        cargar_mapa('https://siata.gov.co/sitio_web/application/assets/kml/equipoSocial/hojaDeVidaSATC/LaEstrella_Lainmaculada_RioAburra.kml');
    </script>
</html>
