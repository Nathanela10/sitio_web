...
<div class="row seccion">
    ...
    <div id="" style="width: 100%">
        <img style="width: 100%" src="/sitio_web/application/assets/img/contenido/equipoSocial/territoriosSATC/RioAburraMedellinLaPrimavera.png" alt="Rio Aburrá - La Primavera">
    </div>
    <br><br>
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 col-md-5 col-sm-5 col-xs-5" >
                ...
                <p><b>BARRIO O CORREGIMIENTO:</b> La Primavera</p>
                <p><b>SECTOR:</b> La Primavera</p>
                <p><b>CUENCA:</b> Río Aburrá - Medellín</p>
                <p><b>ÁREA:</b> 843,4 Km<sup>2</sup></p>
            </div>
        </div>
    </div>
    <br><br>
    ...
    <div style="text-align: center;">
        <iframe style="width: 80%; height:70%;" src="https://www.youtube.com/embed/YL1fKUWyzHE"
    ...
    <br><br>
    <div style="text-align: center;">
        <iframe style="width: 80%; height:70%;" src="https://www.youtube.com/embed/bIsjyjGIkyo"
                frameborder="0" allowfullscreen></iframe>
    </div>
    ...
    <?php $this->view('templates/header/importScripts')?>
        ...
        <script>
            cargar_mapa('https://siata.gov.co/sitio_web/application/assets/kml/equipoSocial/hojaDeVidaSATC/Barbosa_LaPrimavera_RioAburra.kml');
        </script>
</html>
