...
<div class="row seccion">
    ...
    <div id="" style="width: 100%">
        <img style="width: 100%" src="/sitio_web/application/assets/img/contenido/equipoSocial/territoriosSATC/QuebradaLaMadera.png" alt="Quebrada La Madera">
    </div>
    <br><br>
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 col-md-5 col-sm-5 col-xs-5" >
                ...
                <p><b>BARRIO O CORREGIMIENTO:</b> José Antonio Galán</p>
                <p><b>SECTOR:</b> José Antonio Galán</p>
                <p><b>CUENCA:</b> Q. La Madera y Q. La Montañita</p>
                <p><b>ÁREA:</b> 0,99 Km<sup>2</sup></p>
            </div>
        </div>
    </div>
    <!-- <br><br>
