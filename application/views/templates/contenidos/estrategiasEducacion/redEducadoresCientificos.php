...
<div class="row seccion">
    ...
    <div>
        ...
        <div style="text-align: center;">
            <img style=" width: 65%;margin-left: auto;margin-right: auto;" src="https://siata.gov.co/sitio_web/application/assets/img/contenido/estrategiasEducacion/redEducadoresCientificos/MapaEducadoresCientificos.png" class="img-responsive" alt="mapa educadores cientificos">
        </div>
        <br><br>
        <div style="text-align: center;">
            <iframe width="560" height="315" src="https://www.youtube.com/embed/YsT-SGdEHXw" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>
        <br><br>
        <div class="container">
            <div class="blog-posts">
                <div class="post featured row">
                    ...
                    <div class="content col-lg-6 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <br>
                        <p>
                            Invitación inicial a los profesores para que nos cuenten lo que vienen haciendo. 
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="blog-posts">
                <div class="post featured row">
                    ...
                    <div class="content col-lg-6 col-md-12 col-sm-12 col-xs-12">
                        <br>
                        <h4>
                            Experiencias SIATA (caja de procesos hidrológicos y mesa oscilatoria). Juegos SIATA (Jenga de riesgos).
                        </h4>
                        <br>
                        <p>
                            I. E. Ntra. Sra del Carmen. Profesora Liliana Rubiano y Beatriz Bustamante.
                            Creación del club científico Super Sapiens.
                        </p>
                        <br>
                        <p>
            ...
            <div class="blog-posts">
                <div class="post featured row">
                    ...
                    <div class="content col-lg-6 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <br>
                        <p>
                            Experiencia del Colegio Colombo Fránces sobre el monitoreo de variables meteorologicas con una estación análoga, desde el año 2006. Virginia.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="blog-posts">
                <div class="post featured row">
                    ...
                    <div class="content col-lg-6 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <br>
                        <p>
                            Experiencia San José de Itaguí.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="blog-posts">
                <div class="post featured row">
                    ...
                    <div class="content col-lg-6 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <br>
                        <p>
                            Experiencia Clodomiro Ramírez. Yanuba y Liliam.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="blog-posts">
                <div class="post featured row">
                    ...
                    <div class="content col-lg-6 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <br>
                        <p>
                            Experiencia de Ramiro Monsalve con los Clubes de Ciencia.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="blog-posts">
                <div class="post featured row">
                    ...
                    <div class="content col-lg-6 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <br>
                        <p>
                            Experiencia profesora Hendys Guzmán Tenjo. Procesos comunitarios. 
                        </p>
                    </div>
                </div>
            </div>
    ...
    <div class="row seccion">
        ...
        <div class="container">
            <div class="blog-posts">
                <div class="post featured row">
                    <div class="image col-lg-6 col-md-12 col-sm-12 col-xs-12">
                        <a href="https://mailchi.mp/siata/cmo-van-nuestras-nubes-4800913" target="_blank">
                            <img style="height: 30%; width: auto;" src="/sitio_web/application/assets/img/contenido/estrategiasEducacion/territorioAlAire/TA_YordanArango.jpg" alt="">
                        </a>
                    </div>
                    <div class="content col-lg-6 col-md-12 col-sm-12 col-xs-12">
                        <h4>Boletín Febrero</h4>
                        <br>
                        <p>"Cuando la educación se aborda desde la reflexión es posible lograr grandes procesos, de ahí la importancia de repensarnos las ciencias desde un contexto cercano como nuestro Valle de Aburrá...
                            "</p>
                    </div>
                </div>
            </div>
