        ...
        <div id="calidadAire" class= "contenedor_redes row-eq-height">
            ...
            <div class="col-md-7 col-lg-7 movilVertical" >
                <div style="text-align: right">
                    ...
                    <span class="circuloConteoEstaciones"><?php echo $conteoEstaciones['acelerometro_giroscopio'];?></span>
                </div>
                <p style="text-align: justify">
        ...
        <div id="meteorologicas" class= "contenedor_redes row-eq-height">
            ...
            <div class="col-md-7 col-lg-7 movilVertical" >
                <div style="text-align: left">
                    ...
                    <span class="circuloConteoEstaciones"><?php echo ((int)$conteoEstaciones['humedad'] + (int)$conteoEstaciones['humedad_stevens'] + (int)$conteoEstaciones['humedad_laderas_5te_rasp'] + (int)$conteoEstaciones['humedad_stevens_laderas_rasp']);?></span>
                </div>
                <p style="text-align: justify">
