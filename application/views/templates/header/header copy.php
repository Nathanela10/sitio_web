                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="height: 50%;background-color: #0a6f7c;">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 text-right" style="height: 100%;">
                            <img style="height: 100%" src="/sitio_web/application/assets/img/header/banner_header.png" usemap="#logos_map">
                            <map name="logos_map">
                                <area style="border-width: 0px;" shape="rect" coords="10,10,40,50" target="_blank" href="https://www.epm.com.co/site/" alt="EPM">
                                <area style="border-width: 0px;" shape="rect" coords="45,10,95,50" target="_blank" href="https://www.isagen.com.co/" alt="ISAGEN">
                                <area style="border-width: 0px;" shape="rect" coords="105,10,140,50" target="_blank" href="https://www.medellin.gov.co/irj/portal/medellin" alt="DAGRED">
                                <area style="border-width: 0px;" shape="rect" coords="145,10,180,50" target="_blank" href="https://www.metropol.gov.co/" alt="Area metropolitana">
                                <area style="border-width: 0px;" shape="rect" coords="185,10,230,50" target="_blank" href="https://www.medellin.gov.co/irj/portal/medellin" alt="Alcaldía de Medellín">
                            </map>
                        </div>
                    </div>
                </div>
